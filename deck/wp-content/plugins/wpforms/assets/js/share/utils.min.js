    ...
    const a = {
        ...
        cssColorsUtils: {
            ...
            getColorWithOpacity(r, t) {
                r = r.trim();
                var o = a.cssColorsUtils.getColorAsRGBArray(r);
                if (!o) return r;
            ...
            rgbaToHex(r) {
                var t, o, e, s, l;
                return /^rgb/.test(r) ? !!(s = a.cssColorsUtils.getColorAsRGBArray(r)) && (t = Number(s[0]), o = Number(s[1]), e = Number(s[2]), s = s[3] ? Math.round(255 * Number(s[3])) : 255, ("#" + [(l = r => r.toString(16).padStart(2, "0"))(t), l(o), l(e), s < 255 ? l(s) : ""].join("")).toLowerCase()) : r
            }
        }
    };
    return a
